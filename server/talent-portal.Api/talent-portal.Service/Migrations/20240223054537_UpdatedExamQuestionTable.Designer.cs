...
namespace talent_portal.Service.Migrations
{
    ...
    [Migration("20240223054537_UpdatedExamQuestionTable")]
    partial class UpdatedExamQuestionTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("talent_portal.Domain.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("talent_portal.Domain.Models.CareerCounselling", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("talent_portal.Domain.Models.ExamQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("talent_portal.Domain.Models.ExamResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("talent_portal.Domain.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("talent_portal.Domain.Models.ExamResult", b =>
                {
                    b.HasOne("talent_portal.Domain.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("talent_portal.Domain.Models.Job", "Job")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
